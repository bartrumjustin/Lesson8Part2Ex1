namespace assignment8ex1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            HereComesTheSun.end();
            */
            Play run = HereComesTheSun.chorus;
            run += HereComesTheSun.verse1;
            run += HereComesTheSun.chorus;
            run += HereComesTheSun.verse2;
            run += HereComesTheSun.chorus2;
            run += HereComesTheSun.verse3;
            run += HereComesTheSun.chorus;
            run += HereComesTheSun.chorus;
            run += HereComesTheSun.end;
